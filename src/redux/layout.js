...
export const layoutSlice = createSlice({
  ...
  initialState: {
    ...
    isRTL: localStorage.getItem('direction') || themeConfig.layout.isRTL,
  ...
  reducers: {
    handleRTL: (state, action) => {
      ...
      window.localStorage.setItem('direction', action.payload)
    },
    handleSkin: (state, action) => {
      state.skin = action.payload
      window.localStorage.setItem('skin', action.payload)
    },
